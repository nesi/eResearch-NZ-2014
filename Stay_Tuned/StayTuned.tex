...
\frame[t]
{
  ...
  PhyML is developed in NZ and is world-famous software in Phylogenetics. In this case, the right compilers and optimization options for an specific architecture increased the performance up to x5.
  \end{block}
}
...
\hline 
1 & 1000 & 2.71 & 2.72 & 7371.2 &  7.37\\ 
\hline 
4 & 1000 & 7.27 & 2.32 & 16866.4 & 4.22 \\ 
\hline 
8 & 1000 & 7.61 & 1.68 & 12784.8 & 1.60 \\ 
\hline 
16 & 1000 & 6.74 & 1.34 & 9031.6 & 0.56 \\ 
\hline 
\end{tabular}
\end{small}
\end{center}
